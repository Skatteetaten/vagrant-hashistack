...
Any valid configuration from [https://www.consul.io/docs/agent/options.html#configuration_files]() will work.
See [example](../../../example/vagrant/conf/consul/99-override.hcl)
